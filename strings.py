...
instructions_str =( f"Добро пожаловать!\n"
            "Я чат бот компании Profusion Cars. Здесь вы сможете найти ответы на все интересующий вас вопросы. \n"
            "\n"
            "Доступные команды:\n"
            "/questions - Часто задаваемые вопросы\n"
            "/cars - Показать список машин и комплектаций\n"
...
input_phone_number = "Пожалуйста напишите свой номер телефон:"

input_correct_phone_number = "Пожалуйста, введите корректный номер телефона в формате +77011234567."

manager_call = "Спасибо за вашу заявку, наши менеджеры вам позвонят в скором времени"

call_command_text = "Пожалуйста напишите /call чтобы оформить звонок от менеджера"
